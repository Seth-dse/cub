...
| 13 | account | a class with state and methods | §13 |
| 14 | shapes | building on a class, replacing a method | §13 |
| 15 | catalogue | all of it, across two files, and text that may not parse | §14–17 |
