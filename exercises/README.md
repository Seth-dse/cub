...
| 13 | account | a class with state and methods | §14 |
| 14 | shapes | building on a class, replacing a method | §14 |
| 15 | catalogue | all of it, across two files, and text that may not parse | §15–18 |
